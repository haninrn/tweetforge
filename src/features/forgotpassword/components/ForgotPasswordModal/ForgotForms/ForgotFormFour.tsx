...
export const ForgotFormFour:React.FC<ForgotFormFourProps> = ({updatePassword, matching}) => {
    ...
    return(
        <div className="forgot-form-container">
            ...
            <p className="forgot-form-text color-gray">
                You'll be logged out of all active TweetForge sessions after you password is changed.
            </p>
            <div className="forgot-form-four-password-wrapper">
                <ValidatedTextInput
                    ...
                    {passwordToggle ? <VisibilityOffOutlinedIcon sx={{
                        fontSize:"24px"
                    }} /> : 
            ...
            <div className="forgot-form-four-password-wrapper">
                <ValidatedTextInput
                   ...
                   <div onClick={toggleConfirm} className="forgot-form-four-password-icon">
                    {confirmToggle ? <VisibilityOffOutlinedIcon sx={{
                        fontSize:"24px"
                    }} /> : 
                    <VisibilityOutlinedIcon sx = {{
                        fontSize: "24px"
            ...
            {!matching ? <p className="login-form-error color-red">Password must match</p> : <></>}
        </div>
    )
