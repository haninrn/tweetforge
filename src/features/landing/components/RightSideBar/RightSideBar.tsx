...
export const RightSideBar:React.FC<RightSideBarProps> = ({toggleRegister, toggleLogin}) => (
    <div className="right-side-bar">
        ...
        <h2 className="right-side-bar-h2">Join Fwitter Today.</h2>
            ...
            <p className="right-side-bar-legal color-gray">By signing up, you agree to the <span className="link color-blue">
                Terms of Service</span> and <span className="link color-blue">Privacy Policy</span>, including <span
                className="link color-blue">Cookies Use.</span></p>
        </div>
