...
import { StyledInputProps } from "../../features/register/utils/GlobalInterfaces";

import { determineStyledInputBorder, determineLabelColor } from "../../features/register/utils/DetermineStylesUtil";
