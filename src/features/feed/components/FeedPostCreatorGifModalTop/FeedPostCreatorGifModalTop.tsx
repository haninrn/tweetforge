    ...
    return(
        <div className="feed-post-creator-gif-modal-top">
            ...
            <label htmlFor='gif-search' className={inputFocused ? "feed-post-creator-gif-modal-top-input-wrapper input-wrapper-active" : "feed-post-creator-gif-modal-top-input-wrapper input-wrapper-inactive"}>
                ...
                <input id="gif-search" style={!inputFocused && searchTerm.length > 0 ? {width: `${searchTerm.length + 1}ch`} : {}} className="feed-post-creator-gif-modal-top-input" placeholder='Search for GIFs' value={searchTerm} onChange={handleChangeValue} onFocus={handleFocus} onBlur={handleBlur} ref={inputRef} onKeyUp={handleKeyUp}/>
