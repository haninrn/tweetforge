        ...
        <div className="feed-post-creator-gif-modal-top">
            ...
            "feed-post-creator-gif-modal-top-input-wrapper input-wrapper-inactive"}>
                <div className="feed-post-creator-gif-modal-search">
                    <Search sx={{fontSize: '20px', color: 'rgba(83, 100, 113)'}} />
                </div>
                <input id="gif-search" style={!inputFocused && inputValue.length > 0 ? {width: `${inputValue.length + 1}ch`} : {}}
                className="feed-post-creator-gif-modal-top-input" placeholder="Search for GIFs" value={inputValue} onChange={handleChangeValue} onFocus={handleFocus} onBlur=
                {handleBlur} ref={inputRef} />
                {inputValue && inputFocused ? <div className="feed-post-creator-gif-modal-top-clear-border">
