...
export const LandingFooter:React.FC = () => {
    return(
        ...
        <p className="footer-link color-gray">Terms Of Services</p>
        ...
        <p className="footer-link color-gray">Careers</p>
        ...
        <p className="footer-link color-gray">Twittwer for Business</p>
