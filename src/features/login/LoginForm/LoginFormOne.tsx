...
export const LoginFormOne:React.FC=() => {
    return (
        <div className="login-form-one-container" >
            ...
            />
            <button>Next</button>
            <button className="login-form-forgot-password-button">Forgot password?</button>
            <p className="login-form-one-text color-gray">Don't have and account? <span className="link color-blue">Sign Up</span></p>
        </div>
    )
}