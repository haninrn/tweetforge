        ...
        <div className="register-container">
            <div className="register-content">
                ...
                <div className="register-three-value-wrapper">
                    ...
                    {state.error ?
                        <p className="register-error color-red">The email you specified is in use, please use a different one</p> : <></>
                    }    
                </div>
                ...
                <p className="register-text-sm color-gray">
                    By signing up you agree <span className="register-link color-blue">Terms of Services</span> and <span
                    className='reg-step-three-link'>Privacy Policy</span>, including <span className="register-link color-blue">Cookie
                    ...
                    <span className="register-link color-blue">Learn more</span>. Others will be able to find you by email or phone
                    number. when provided unless you choose otherwise <span className="register-link color-blue">here</span>.
                </p>
            </div>
        </div>
    )
